...
let htmlquestion = [
 ...
 function setname() {
     let localstgname = localStorage.getItem('EEE@GMAIL.COM');
     console.log(localstgname);
     let thisname = JSON.parse(localstgname)
     console.log(thisname);
     console.log(thisname[0].firstName);
     let x = thisname[0].firstName
 ...
 setname()
    ...
    function gettopic ()
{
    let userinfo = localStorage.getItem('EEE@GMAIL.COM');
    let objuser = JSON.parse(userinfo);
    console.log(objuser[0].topic);
    return objuser[0].topic;
...
function gotoresultpg()
{
    ...
    for(let i =0 ;  i < answersarr.length;i++)
    {
        ...
        {
            falsecounter ++ ;
            wrongansarr[x] = choosedtopicarr[i];
            x++;
        }
    ...
    localStorage.setItem("userwrongans" , wrongansertolocal)
